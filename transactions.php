...
echo"<div class='container'>";
	...
	echo"	<div class = 'navbar'>";
			...
			echo "<h2><center>Transactions</center><h2>";
...
$statement = "SELECT *, payements.transaction_code FROM vehicle INNER JOIN payements ON vehicle.vehicle_id = payements.vehicle_id AND payements.seller_email='$email'";
...
echo "<div class= 'item_row'><b><h3>Transaction Code:$transaction_code</h3></b></div>";

echo "<label class='item_row'>Status:<label>";
echo "<input type='text' value='pending' list='status'>";
